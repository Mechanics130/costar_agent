# CoStar Host-model Prompt Packet for Claude

This packet defines how Claude should use CoStar in Host-model mode.

## Mission

Claude is the reasoning and orchestration layer. CoStar remains the durable relationship system of record.
